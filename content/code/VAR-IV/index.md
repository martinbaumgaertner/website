...
description: "R package for a VAR with external instruments including robust CI"
---

**Author:** Martin Baumgärtner
**Date:** November 19, 2019
**Language:** R
**GitHub:** [martinbaumgaertner/varexternal](https://github.com/martinbaumgaertner/varexternal)

## Description

R package for a VAR with external instruments including robust confidence intervals.
...
_Disclaimer: Although the methodology and the basic code is not mine, all errors are first to be credited to me personally. Please note that this package has not yet been tested extensively. I am grateful for every hint for improvement._
